...
namespace CleanserBlazorUI.Migrations
{
    ...
    [Migration("20260831031311_ExpandSubscriberShortCodes")]
    partial class ExpandSubscriberShortCodes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanserBlazorUI.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.BusSettNormalizer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BusinessClassNormalizer");
                });

            modelBuilder.Entity("CleanserBlazorUI.Entities.BusinessRef", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CreditFacilityAccNum")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("CurrenVersion")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("LastConfirmedReportingPeriod")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.IndividualRef", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DriverLicNum")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.SettingsClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.SubscribeContext", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubscriberShortCodes");
                });

            modelBuilder.Entity("CleanserBlazorUI.Entities.SubscriberProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.UnloadableLogCategoryDetail", b =>
                {
                    ...
                    b.Property<string>("DescriptionOfErrors")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("UnloadableLogHeaderId")
                        .HasColumnType("int");

                    b.Property<int>("VolumeAffected")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UnloadableLogHeaderId");

                    b.ToTable("UnloadableLogCategoryDetails");
                });
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.UnloadableLogHeader", b =>
                {
                    ...
                    b.Property<int>("SubscriberProfileId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnloadableLogHeaders");
                });

            modelBuilder.Entity("CleanserBlazorUI.Entities.UnloadableLogMessageDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnloadableLogMessageDetails");
                });
            ...
            modelBuilder.Entity("CleanserBlazorUI.Entities.UnloadableLogCategoryDetail", b =>
                {
                    b.HasOne("CleanserBlazorUI.Entities.UnloadableLogHeader", "UnloadableLogHeader")
                        ...
                        .HasForeignKey("UnloadableLogHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UnloadableLogHeader");
                });

            modelBuilder.Entity("CleanserBlazorUI.Entities.UnloadableLogHeader", b =>
                {
                    b.HasOne("CleanserBlazorUI.Entities.SubscriberProfile", "SubscriberProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CleanserBlazorUI.Data.ApplicationUser", null)
                        .WithMany()
